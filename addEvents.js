...
async function main() {
    ...
    const listedRespone = await Moralis.Cloud.run("watchContractEvent", itemListedOptions, {
        useMasterKey: true,
    })
    ...
    if (listedRespone.success && canceledResponse.success && boughtResponse.success) {
